...
class Database_PostgreSQL extends \Glue\DB\Database {
	/**
	...
	public function real_table($name) {
		throw new \Glue\DB\Exception("The Database::real_table function isn't implemeted for postgre. If you want this feature, please fork the project on github and add it. The docs to do it are here : http://www.postgresql.org/docs/8.1/interactive/information-schema.html");
	}
	...
	public function real_tables() {
		throw new \Glue\DB\Exception("The Database::real_tables function isn't implemeted for postgre. If you want this feature, please fork the project on github and add it. The docs to do it are here : http://www.postgresql.org/docs/8.1/interactive/information-schema.html");
	}
